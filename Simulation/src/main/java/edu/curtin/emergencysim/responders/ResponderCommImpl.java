 ...
 */
public class ResponderCommImpl implements ResponderComm, EmergencyObserver
{
    /**
...
//         events.add(new REvent(550, "fire", false, "Midtown"));        
        ...
        events.add(new REvent(16, "fire", true, "Hill Valley"));
        ...
        events.add(new REvent(36, "fire", true, "Midtown"));
